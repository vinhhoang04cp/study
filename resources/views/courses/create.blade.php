...
@section('content')
    <div class="topbar">
        <h1 class="page-title"><i class="fas fa-plus-circle"></i> Tạo Khóa Học Mới</h1>
    </div>
        ...
        <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               placeholder="Nhập tên khóa học" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror"
                                   placeholder="0" step="0.01" value="{{ old('price') }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                          rows="5" placeholder="Nhập mô tả khóa học" required>{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
